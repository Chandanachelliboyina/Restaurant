...
export const DISH_IMAGES: Record<string, string> = {
  ...
  "Chettinad Chicken": istockphoto_1258129729,
  ...
  "Kulfi Falooda": photo_1669200236241,
...
export const GALLERY_IMAGES = {
  ...
  chef: [{ src: chefImage, alt: "Chef" }],
  events: [{ src: bgContactImage, alt: "Events" }],
  kitchen: [{ src: bgAboutImage, alt: "Kitchen" }],
};
