...
const SEEDS: Record<Category, Seed[]> = {
  ...
  Pizza: [
    ...
    { name: "Paneer Makhani Pizza", desc: "Tikka paneer, makhani sauce, red onions.", price: 16, veg: true, img: IMG("1573821663912-569905455b1c") },
    { name: "Pesto Verde", desc: "Basil pesto, cherry tomatoes, burrata.", price: 17, veg: true, img: IMG("1534308983496-4fabb1a015ee") },
    { name: "Meat Feast", desc: "Salami, sausage, ham and bacon over mozzarella.", price: 20, veg: false, img: IMG("1628672092908-c92a710bb3d6") },
    { name: "Garden Fiesta", desc: "Roasted peppers, olives, artichoke hearts and mushrooms.", price: 15, veg: true, img: IMG("1617470703128-26a0fc9af10f") },
  ],
  Burgers: [
  ...
  Biryani: [
    ...
    { name: "Paneer Biryani", desc: "Marinated paneer cubes in saffron basmati.", price: 13, veg: true, img: IMG("1691171047462-66025ecd5efc") },
  ...
  "South Indian": [
    ...
    { name: "Idli Sambar", desc: "Steamed rice cakes with lentil stew and chutneys.", price: 6, veg: true, img: IMG("1632104667384-06f58cb7ad44") },
    { name: "Medu Vada", desc: "Fluffy urad-dal doughnuts with coconut chutney.", price: 6, veg: true, img: IMG("1730191843435-073792ba22bc") },
    ...
    { name: "Chettinad Chicken", desc: "Fiery Tamil masala with roasted spices.", price: 14, veg: false, img: IMG("1545247181-516773cae754") },
    { name: "Kerala Fish Curry", desc: "Kokum-tinged coconut curry with tender fish.", price: 15, veg: false, img: IMG("1620894580123-466ad3a0ca06") },
  ...
  "North Indian": [
    ...
    { name: "Palak Paneer", desc: "Spinach purée with soft paneer cubes.", price: 12, veg: true, img: IMG("1589647363585-f4a7d3877b10") },
    ...
    { name: "Amritsari Chicken Curry", desc: "Punjabi home-style chicken with garam masala.", price: 15, veg: false, img: IMG("1603496987351-f84a3ba5ec85") },
  ],
  Desserts: [
    { name: "Gulab Jamun", desc: "Fried milk dumplings soaked in rose cardamom syrup.", price: 6, veg: true, img: IMG("1595608010652-d8bf1103a1c5") },
